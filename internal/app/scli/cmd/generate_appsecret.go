...
// generateCmd represents the cleanCmd command
var generateAppSecretCmd = &cobra.Command{
...
func init() {
	generateCmd.AddCommand(generateAppSecretCmd)
	...
	generateAppSecretCmd.Flags().StringP("framework", "a", "symfony", "Generate APP_SECRET for a framework. Valid values are: symfony")
}
